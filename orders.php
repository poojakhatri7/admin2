...
<?php include 'top_navbar.php'; ?>
 ...
 <div class="content">
  ...
  <div class="table-responsive mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
    <table class="table table-striped table-bordered  table-sm fs-0 mb-0">
      <thead>
        <tr>
